...
const getStationsById = require('./routes/getStationsById')
const syncStations = require('./routes/syncStations')
const deleteStation = require('./routes/deleteStation')
const updateStation = require('./routes/updateStation')
const createStation = require('./routes/createStation')
...
app.use('/station', getStationsById)
app.use('/station', syncStations)
app.use('/station', deleteStation)
